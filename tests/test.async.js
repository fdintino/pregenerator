...
describe("async functions and await expressions", function () {
  ...
  describe("nested async function calls", function () {
    it(
      "should evaluate in the right order",
      new Function(
        "done",
        compile(
          [
  ...
  describe("dependent promises", function () {
    it(
      "should be awaitable out of order",
      new Function(
        "done",
        compile(
          [
  ...
  describe("rejected promises", function () {
    it(
      "should cause await expressions to throw",
      new Function(
        "done",
        compile(
          [
    ...
    it(
      "should be returned by exceptional async functions",
      new Function(
        "done",
        compile(
          [
    ...
    it(
      "should propagate failure when returned",
      new Function(
        compile(
          [
            "  return function() {",
...
describe("async generator functions", function () {
  it(
    "should return a working AsyncIterator",
    new Function(
      compile(
        [
          "return function() {",
  ...
  it(
    "should be able to handle many awaits",
    new Function(
      compile(
        [
          "return function() {",
  ...
  it(
    "should not propagate exceptions between iterations",
    new Function(
      compile(
        [
          "return function() {",
  ...
  it(
    "should allow yielding a rejected Promise",
    new Function(
      compile(
        [
          "return function() {",
  ...
  it(
    "should work with nested arrow functions",
    new Function(
      compile(
        [
...
describe("update operators", function () {
  it(
    "should read left side before yielding",
    new Function(
      compile(
        [
          "return function() {",
  ...
  it(
    "should explode left side before yielding",
    new Function(
      compile(
        [
          "return function() {",
  ...
  it(
    "should read left side before awaiting",
    new Function(
      compile(
        [
          "return function() {",
