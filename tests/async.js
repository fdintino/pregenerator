...
var {compile: _compile} = require('pregenerator');
...
describe('async functions and await expressions', function() {
  ...
  describe('regeneratorRuntime', function() {
    it('should be defined globally', new Function(compile(`
      return function() {
    ...
    it('should have a .wrap method', new Function(compile(`
      return function() {
  ...
  describe('Promise', function() {
    ...
    it('should be a function', new Function(compile(`
      return function() {
  ...
  describe('no-await async function', function() {
    it('should return a Promise', new Function('done', compile(`
  ...
  describe('one-await async function', function() {
    it('should finish asynchronously', new Function('done', compile(`
      return function(done) {
        var flag1 = false;
        var flag2 = false;
  ...
  describe('nested async function calls', function() {
    it('should evaluate in the right order', new Function('done', compile(`
      return function(done) {
        var markers = [];
  ...
  describe('dependent promises', function() {
    it('should be awaitable out of order', new Function('done', compile(`
      return function(done) {
  ...
  describe('rejected promises', function() {
    it('should cause await expressions to throw', new Function('done', compile(`
      return function(done) {
  ...
  `))());
    ...
    it('should be returned by exceptional async functions', new Function('done', compile(`
      return function(done) {
        var error = new Error('rejected');
  ...
  `))());
    ...
    it('should propagate failure when returned', new Function(compile(`
      return function() {
  ...
  describe('async function expressions', function() {
    it('should be allowed', new Function('done', compile(`
      return function(done) {
        (async function(arg) {
          return await arg;
  ...
  `))());
    ...
    it('should respect .call\'s this', new Function('done', compile(`
      return function(done) {
        async function f() {
          return this;
        }
  ...
  `))());
    ...
    it('shouldn\'t capture this when not needed', new Function(compile(`
      return function() {
...
describe('async generator functions', function() {
  it('should return a working AsyncIterator', new Function(compile(`
    return function() {
      var markers = [];
  ...
  it('should keep results in order', new Function(compile(`
    return function() {
  ...
  it('should be able to handle many awaits', new Function(compile(`
    return function() {
      var awaitCount = 0;
  ...
  it('should not propagate exceptions between iterations', new Function(compile(`
    return function() {
      async function *gen() {
        yield 1;
        yield 2;
...
describe('update operators', function() {
  it('should read left side before yielding', new Function(compile(`
    return function() {
      let x = 0;
  ...
  it('should explode left side before yielding', new Function(compile(`
    return function() {
      let obj = { count: 0 };
  ...
  it('should read left side before awaiting', new Function(compile(`
    return function() {
      let x = 0;
