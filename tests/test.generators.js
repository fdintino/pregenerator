...
describe("generators", function () {
  ...
  describe("simple argument yielder", function () {
    ...
    it(
      "should support multiple yields in expression",
      new Function(
        "assert",
        compile(
          [
  ...
  describe("range generator", function () {
    it(
      ...
      new Function(
        ...
        "range",
        compile(
          ["return function() {", "  check(range(0), []);", "};"].join("\n")
        )
      )(check, range)
    );
  ...
  describe("try-finally generator", function () {
    ...
    it(
      "should override abrupt with return",
      new Function(
        "check",
        "usingAbrupt",
        compile(
    ...
    it(
      "should override abrupt with break",
      new Function(
        "check",
        "usingAbrupt",
        compile(
    ...
    it(
      "should override abrupt with continue",
      new Function(
        "check",
        "usingAbrupt",
        compile(
    ...
    it(
      "should run finally after break within try",
      new Function(
        "check",
        compile(
          [
    ...
    it(
      "should return the correct value when overridden by finally",
      new Function(
        "assert",
        compile(
          [
    ...
    it(
      "should let the last finally block override all others",
      new Function(
        "assert",
        compile(
          [
    ...
    it(
      "should allow additional yields during finally propagation",
      new Function(
        "assert",
        compile(
          [
  ...
  describe("try-catch-finally generator", function () {
    ...
    it(
      "should execute catch and finally blocks at most once",
      new Function(
        "assert",
        "check",
        compile(
    ...
    it(
      "should handle backwards jumps in labeled loops",
      new Function(
        "check",
        compile(
          [
    ...
    it(
      "should handle loop continue statements properly",
      new Function(
        "assert",
        compile(
          [
  ...
  describe("for-in loop generator", function () {
    /* eslint-disable guard-for-in, block-scoped-var, no-sequences*/
    it(
    ...
    it(
      "should handle property deletion in loop",
      new Function(
        "assert",
        "check",
        compile(
    ...
    it(
      "should loop over inherited properties",
      new Function(
        "check",
        compile(
          [
    ...
    it(
      "should handle risky object expressions",
      new Function(
        "assert",
        "check",
        compile(
    ...
    it(
      "should allow non-Identifier left-hand expressions",
      new Function(
        "check",
        "assert",
        compile(
      ...
      new Function(
        ...
        compile(
          [
            ...
            "    done: false",
            "  });",
            "  var complaint = g.next(g);",
            "  // Sending the generator to itself.",
  ...
  describe("delegated yield", function () {
    ...
    it(
      "should be governed by enclosing try statements",
      new Function(
        "check",
        "raise",
        compile(
          [
            "return function() {",
            "  /*eslint-disable space-unary-ops, space-infix-ops*/",
            '  var error = new Error("thrown");',
            "  function* outer(n) {",
            "    try {",
            "      yield 0;",
    ...
    it(
      "should dispatch .thrown exceptions correctly",
      new Function(
        "assert",
        compile(
          [
    ...
    it(
      "should call .return methods of delegate iterators",
      new Function(
        "Symbol",
        "assert",
        "check",
        ...
        compile(
          [
            "return function() {",
            "  /*eslint-disable dot-notation, no-redeclare*/",
      ...
      )(Symbol, assert, check, fullCompatibility)
    );

    it(
      "should not be required to have a .return method",
      new Function(
        "Symbol",
        "assert",
        "fullCompatibility",
      ...
      )(Symbol, assert, fullCompatibility, range)
    );

    it(
      "should execute finally blocks of delegate generators",
      new Function(
        "assert",
        compile(
          [
    ...
    it(
      "should evaluate to the return value of the delegate",
      new Function(
        "check",
        "fullCompatibility",
        "Symbol",
        compile(
          [
            ...
            "  }",
            "  check(outer(arrayDelegate), [3, 4], undefined);",
            "  // See issue #143.",
            "  if (!fullCompatibility) {",
            "    return;",
            "  }",
      ...
      )(check, fullCompatibility, Symbol)
    );

    it(
      "should work as a subexpression",
      new Function(
        "check",
        "fullCompatibility",
        "Symbol",
  ...
  (fullCompatibility ? describe : xdescribe)(
    "generator return method",
    function () {
      it(
        "should work with newborn generators",
        new Function(
          "assert",
        ...
        )(assert, assertAlreadyFinished)
      );
      it(
        "should behave as if generator actually returned",
        new Function(
          "assert",
          "assertAlreadyFinished",
          compile(
      ...
      it(
        "should return both delegate and delegator",
        new Function(
          "assert",
          compile(
            [
  ...
  describe("function declaration hoisting", function () {
    ...
    it(
      "should work for nested generator function declarations",
      new Function(
        "assert",
        "check",
        compile(
    ...
    it(
      "should not interfere with function rebinding",
      new Function(
        "assert",
        "check",
        compile(
    ...
    it(
      "should not interfere with nested function rebinding itself",
      new Function(
        "check",
        compile(
          [
  ...
  describe("the arguments object", function () {
    ...
    // it("should be shadowable by explicit declarations (sloppy)", new Function("check", compile(`
    // return function() {
  ...
  describe("the this object", function () {
    it(
      "should default to undefined (strict)",
      new Function(
        "assert",
        compile(
          [
    ...
    it(
      "shouldn't capture this when not needed",
      new Function(
        "assert",
        compile(
          [
  ...
  describe("directive strings", function () {
    it(
      "should be kept at top of outer function",
      new Function(
        "assert",
        "check",
        compile(
  ...
  describe("catch parameter shadowing", function () {
    ...
    (fullCompatibility ? xit : it)(
      ...
      function () {
        /* eslint-disable no-ex-assign, no-unused-vars*/
        function* gen(x) {
          try {
            throw x;
          } catch (x) {
    ...
    it(
      "should allow nested catch parameters of the same name",
      new Function(
        "raise",
        "check",
        compile(
    ...
    it(
      "should not interfere with non-referential identifiers",
      new Function(
        "raise",
        "assert",
        compile(
  ...
  describe("object literals with multiple yields", function () {
    it(
      "should receive different sent values",
      new Function(
        "check",
        compile(
          [
  ...
  describe("generator .throw method", function () {
    it(
      "should work after the final call to .next",
      new Function(
        "assert",
        compile(
          [
    ...
    it(
      "should immediately complete a new-born generator",
      new Function(
        "assert",
        compile(
          [
    ...
    it(
      "should not propagate errors handled inside a delegate",
      new Function(
        "assert",
        compile(
          [
    ...
    it(
      "should propagate errors unhandled inside a delegate",
      new Function(
        "assert",
        compile(
          [
  ...
  describe("unqualified function calls", function () {
    it(
      "should have a global `this` object",
      new Function(
        "assert",
        compile(
          [
  ...
  describe("isGeneratorFunction", function () {
    ...
    it(
      "should work for function expressions",
      new Function(
        "assert",
        compile(
          [
            "return function() {",
            "  assert.strictEqual(regeneratorRuntime.isGeneratorFunction(function* genFun() {",
            "    yield 0;",
            "  }), true);",
  ...
  describe("new expressions", function () {
    it(
      "should be able to contain yield sub-expressions",
      new Function(
        "assert",
        compile(
          [
  ...
  describe("block binding", function () {
    it(
      "should translate block binding correctly",
      new Function(
        "assert",
        compile(
          [
    ...
    it(
      "should translate block binding with iife correctly",
      new Function(
        "assert",
        compile(
          [
  ...
  describe("newborn generators", function () {
    it(
      "should be able to yield* non-newborn generators",
      new Function(
        "assert",
        compile(
          [
    ...
    it(
      "should support the ignore-initial-yield wrapper idiom",
      new Function(
        "assert",
        compile(
          [
    ...
    it(
      "should allow chaining newborn and non-newborn generators",
      new Function(
        "check",
        "assert",
        compile(
          [
            ...
            "  });",
            "  var undef;",
            "  // A little easier to read than undefined.",
  ...
  describe("labeled break and continue statements", function () {
    /* eslint-disable no-extra-label, no-unused-labels*/
    it(
      "should be able to exit multiple try statements",
      new Function(
        "raise",
        "check",
        "assert",
        compile(
          [
            ...
            "  }",
            "  try {",
            '    check(gen(3, "continue"), [0, 1, 0, 2, 3, 4, "continuing", 1, 2, 3, 4, "continuing", 2, 2, 3, 4, "continuing", 6]);',
            '    assert.ok(false, "should have thrown an exception");',
            "  } catch (err) {",
            "    assert.strictEqual(err, e1);",
            "  }",
    ...
    it(
      "should allow breaking from any labeled statement",
      new Function(
        "check",
        compile(
          [
  ...
  describe("generator function prototype", function () {
    /* eslint-disable no-redeclare, no-proto, no-func-assign*/
    function getProto(obj) {
      return Object.getPrototypeOf ? Object.getPrototypeOf(obj) : obj.__proto__;
    }
    it(
      "should follow the expected object model",
      new Function(
        "assert",
        "getProto",
        compile(
  ...
  describe("for-of loops", function () {
    ...
    it(
      "should work inside of generators",
      new Function(
        "assert",
        "check",
        compile(
  ...
  describe("expressions containing yield subexpressions", function () {
    it(
      "should evaluate all subexpressions before yielding",
      new Function(
        "assert",
        compile(
          [
    ...
    it(
      "should work even with getter member expressions",
      new Function(
        "assert",
        compile(
          [
    ...
    it(
      "should evaluate all array elements before yielding",
      new Function(
        "assert",
        compile(
          [
    ...
    it(
      "should handle callee member expressions correctly",
      new Function(
        "assert",
        compile(
          [
    ...
    it(
      "should handle implicit stringification correctly",
      new Function(
        "assert",
        compile(
          [
