...
describe('@@iterator', function() {
  it('is defined on Generator.prototype and returns this', new Function('Symbol', compile(`
    return function() {
      function *gen(){}
      var iterator = gen();
...
describe('throw', function() {
  it('should complete throwing generator', new Function('Symbol', 'assertAlreadyFinished', compile(`
    return function() {
      function *gen(x) {
        throw 1;
      }
  ...
  it('should complete yielding/throwing generator', new Function('Symbol', 'assertAlreadyFinished', compile(`
    return function() {
      function *gen(x) {
        yield 2;
        throw 1;
...
describe('completed generator', function() {
  it('should refuse to resume', new Function('Symbol', 'assertAlreadyFinished', compile(`
    function *gen() {
      return 'ALL DONE';
    }
    return function() {
...
describe('delegate yield', function() {
  it('should support any iterable argument', new Function('Symbol', 'check', compile(`
    return function() {
      function *gen() {
        yield 0;
        yield* [
