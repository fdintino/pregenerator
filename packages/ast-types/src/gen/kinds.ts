...
export type PatternKind = namedTypes.ObjectPattern | namedTypes.ArrayPattern | namedTypes.AssignmentPattern;
export type PatternLikeKind = namedTypes.Identifier | namedTypes.RestElement | namedTypes.ObjectPattern | namedTypes.ArrayPattern | namedTypes.AssignmentPattern | namedTypes.JSXIdentifier | namedTypes.PrivateName | namedTypes.TSAsExpression | namedTypes.TSNonNullExpression | namedTypes.TSTypeParameter | namedTypes.TSTypeAssertion | namedTypes.TSParameterProperty;
